...
/**
 * AndroidDevelopmentOfferLetter Component
 * Internship Offer Letter for Android Development
 * Supports stamped background via withStamp prop
 */
const AndroidDevelopmentOfferLetter = ({ data, withStamp = false }) => {
    const {
        candidateName,
        collegeName,
        internshipFrom,
        ...
        >
            <div className="absolute inset-x-10 top-40 bottom-10 px-4">
                ...
                <p className="mb-5 text-justify">
                    We are pleased to offer you the position of <b>Android Development Intern</b>{" "}
                    at <b>SS Infotech </b>. This internship aims to enhance your
                    practical understanding of mobile app development and the Android ecosystem.
                </p>
