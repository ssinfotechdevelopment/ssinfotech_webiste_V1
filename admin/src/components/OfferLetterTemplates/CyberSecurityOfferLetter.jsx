...
/**
 * CyberSecurityOfferLetter Component
 * Internship Offer Letter for Cyber Security
 * Supports stamped background via withStamp prop
 */
const CyberSecurityOfferLetter = ({ data, withStamp = false }) => {
  const {
    candidateName,
    collegeName,
    internshipFrom,
    ...
    >
      <div className="absolute inset-x-10 top-40 bottom-10 px-4">
        ...
        <p className="mb-5 text-justify">
          ...
          monitoring, basic penetration testing, security assessments, log analysis,
          documentation of vulnerabilities, and supporting the team in improving
          overall security posture. You will also learn network scanning methods,
          common attack vectors, and best mitigation practices while adhering to
          ethical guidelines, documentation standards, and security best practices.
        </p>

        {/* Expectations & Completion Certificate */}
        <p className="mb-6 text-justify">
          You are expected to maintain professionalism, teamwork, punctuality,
          and strict confidentiality throughout the internship period. Regular reporting,
