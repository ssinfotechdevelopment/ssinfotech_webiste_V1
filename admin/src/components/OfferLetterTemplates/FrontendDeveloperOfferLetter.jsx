...
/**
 * FrontendDeveloperOfferLetter Component
 * Internship Offer Letter for Frontend Development
 * Supports stamped background via withStamp prop
 */
const FrontendDeveloperOfferLetter = ({ data, withStamp = false }) => {
    const {
        candidateName,
        collegeName,
        internshipFrom,
    ...
    return (
        ...
        >
            <div className="absolute inset-x-10 top-40 bottom-10 px-4">
                ...
                {/* Responsibilities */}
                <p className="mb-5 text-justify">
                    During the internship, you will work closely with our UI/UX and frontend
                    teams on building responsive, performant, and pixel-perfect user interfaces
                    using modern frameworks such as React, Vue, or Angular. You will be involved
                    in component development, state management, API integration, accessibility
                    improvements, and optimizing user experience while following coding standards,
