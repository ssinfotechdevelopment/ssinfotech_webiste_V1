...
/**
 * HumanResourcesOfferLetter Component
 * Internship Offer Letter for Human Resources (HR)
 * Supports stamped background via withStamp prop
 */
const HumanResourcesOfferLetter = ({ data, withStamp = false }) => {
  const {
    candidateName,
    collegeName,
    internshipFrom,
  ...
  return (
    ...
    >
      <div className="absolute inset-x-10 top-40 bottom-10 px-4">
        ...
        {/* Responsibilities */}
        <p className="mb-5 text-justify">
          During the internship, you will assist in resume screening, interview
          coordination, employee record management, attendance tracking, payroll
          support, policy implementation, and organizing team engagement activities.
          You will adhere to HR policies, maintain strict confidentiality of sensitive
          information, and follow documentation and compliance guidelines.
        </p>

        {/* Expectations & Completion Certificate */}
        <p className="mb-6 text-justify">
          You are expected to maintain professionalism, teamwork, punctuality,
          and strict confidentiality throughout the internship period. Regular
          reporting, task updates, and active participation in team meetings
