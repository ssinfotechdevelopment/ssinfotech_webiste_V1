        ...
        >
            <div className="absolute inset-x-10 top-40 bottom-10">
                ...
                <p className="mb-3 text-justify">
                    ...
                    implement VLANs, monitor networks using tools like Wireshark or PRTG,
                    troubleshoot connectivity issues, and assist in network security implementation.
                    You will follow standard networking protocols, documentation guidelines,
                    and best practices.
                </p>
