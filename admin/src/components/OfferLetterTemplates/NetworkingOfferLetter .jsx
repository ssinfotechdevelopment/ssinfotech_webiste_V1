...
/**
 * NetworkingEngineerOfferLetter Component
 * Internship Offer Letter for Networking Engineer
 * Supports stamped background via withStamp prop
 */
const NetworkingEngineerOfferLetter = ({ data, withStamp = false }) => {
    const {
        candidateName,
        collegeName,
        internshipFrom,
        ...
        >
            <div className="absolute inset-x-10 top-40 bottom-10 px-4">
                ...
                <p className="mb-5 text-justify">
                    We are pleased to offer you the position of <b>Networking Engineer Intern</b>{" "}
                    at <b>SS Infotech </b>. This internship aims to enhance your
                    practical understanding of network design, configuration, security,
                    and administration in real-world environments.
                </p>
                ...
                {/* Responsibilities */}
                <p className="mb-5 text-justify">
                    During the internship, you will configure routers, switches, and firewalls,
                    implement VLANs and subnetting, monitor networks using tools like Wireshark,
                    PRTG, or SolarWinds, troubleshoot connectivity and performance issues,
                    assist in network security implementation (firewalls, VPNs, access controls),
                    and document network topologies. You will adhere to standard networking
                    protocols, documentation guidelines, and industry best practices.
                </p>
