...
/**
 * SystemEngineerOfferLetter Component
 * Internship Offer Letter for System Engineering
 * Supports stamped background via withStamp prop
 */
const SystemEngineerOfferLetter = ({ data, withStamp = false }) => {
    const {
        candidateName,
        collegeName,
        internshipFrom,
        ...
        >
            <div className="absolute inset-x-10 top-40 bottom-10 px-4">
                ...
                <p className="mb-5 text-justify">
                    We are pleased to offer you the position of <b>System Engineer Intern</b>{" "}
                    at <b>SS Infotech Pvt. Ltd.</b>. This internship aims to enhance your
                    practical understanding of server management, system automation,
                    infrastructure monitoring, and administration in production environments.
                </p>
                ...
                {/* Responsibilities */}
                <p className="mb-5 text-justify">
                    During the internship, you will manage Linux and Windows servers,
                    write automation scripts (Shell/PowerShell/Bash), handle backups and recovery,
                    perform system monitoring using tools like Nagios, Zabbix, or Prometheus,
                    troubleshoot hardware/software issues, implement security patches,
                    and ensure high availability and system reliability. You will follow
                    standard operating procedures, documentation guidelines, and industry best practices.
                </p>
