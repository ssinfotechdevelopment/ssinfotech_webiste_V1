        ...
        >
            <div className="absolute inset-x-10 top-40 bottom-10">
                ...
                <p className="mb-3 text-justify">
                    ...
                    handle backups, perform system monitoring using tools like Nagios or Zabbix,
                    troubleshoot hardware/software issues, and ensure system reliability and security.
                    You will follow standard operating procedures, documentation guidelines,
                    and best practices.
                </p>
