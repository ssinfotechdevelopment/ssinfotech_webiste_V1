        ...
        >
            <div className="absolute inset-x-10 top-40 bottom-10">
                ...
                <p className="mb-3 text-justify">
                    We are pleased to offer you the position of <b>Software Testing & QA Intern</b> at
                ...
                <p className="mb-3 text-justify">
                    During the internship, you will perform manual and automated testing, write test cases,
                    report and track bugs using tools like Jira, work with testing frameworks such as
                    Selenium, Postman, and Cypress, and ensure high-quality software delivery. You will
                    follow testing standards, documentation guidelines, and best practices.
                </p>
