        ...
        <div className="relative w-[794px] h-[1123px] text-[14px] leading-[1.7] bg-white mx-auto"
            ...
            <div className="absolute left-10 right-10 pt-44 pb-10">
                ...
                <p className="mt-6 text-justify">
                    We are pleased to offer you the position of <b>QA / Testing Intern</b> at
                ...
                <p className="mt-6 text-justify">
                    ...
                    report bugs using Jira, work with tools like Selenium, Postman, Cypress and ensure
                    high-quality software delivery. You will follow testing standards and documentation.
                </p>
