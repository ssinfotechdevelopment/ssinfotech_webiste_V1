    ...
    return (
        ...
        >
            <div className="absolute inset-x-10 top-40 bottom-10">
                ...
                <p className="mb-3 text-justify">
                    During the internship, you will create wireframes and high-fidelity mockups using tools
                    such as Figma or Adobe XD, conduct user research, build design systems, develop interactive
                    prototypes, and collaborate with developers for pixel-perfect implementation. You will
                    follow design guidelines, accessibility standards, and industry best practices.
                </p>
