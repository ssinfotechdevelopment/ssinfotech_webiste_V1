    ...
    >
      <div className="absolute inset-x-10 top-40 bottom-10">
        ...
        <p className="mb-3 text-justify">
          We are pleased to offer you the position of <b>Web Developer Intern</b> at
        ...
        <p className="mb-3 text-justify">
          During the internship, you will work on various tasks such as website layout
          structuring, UI enhancements, bug fixing, API integration, and assisting the
          development team in ongoing projects. You will follow coding standards,
