...
function JobApplicationModal({ job, isOpen, onClose }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("https://ssinfotech-webiste-v1-backend.onrender.com/api/applications/fill-applications", {
        method: "POST",
        body: formDataToSend,
      });
  ...
  useEffect(() => {
    const fetchJobs = async () => {
      try {
        ...
        let url = "https://ssinfotech-webiste-v1-backend.onrender.com/api/jobs/show-jobs";
