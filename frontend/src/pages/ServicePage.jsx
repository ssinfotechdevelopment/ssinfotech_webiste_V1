...
import {
  Code, Cpu, Smartphone, Megaphone, Stars, Sparkles, Globe,
  ...
  const services = useMemo(() => [
    {
      ...
      details: [
        { title: "Corporate Website Development", description: "Professional websites that represent your brand and drive business growth." },
        { title: "E-commerce Solutions", description: "Complete online store development with payment integration and inventory management." },
        { title: "Web Application Development", description: "Custom web applications tailored to your business processes and requirements." }
      ]
    },
    {
      id: "mobile-app",
      ...
      details: [
        { title: "Enterprise Mobile Applications", description: "Secure and scalable mobile solutions for your workforce and customers." },
        { title: "Consumer-Facing Apps", description: "Engaging mobile experiences that connect you with your customers." }
      ]
    },
    {
      ...
      details: [
        { title: "Search Engine Optimization", description: "Improve your search rankings and drive organic traffic to your website." },
        { title: "Social Media Marketing", description: "Build brand awareness and engage with your audience across social platforms." }
      ]
    },
    {
      id: "cloud-services",
      ...
      details: [
        { title: "Cloud Infrastructure", description: "Reliable and scalable cloud infrastructure to support your business operations." },
        { title: "Cloud Security", description: "Comprehensive security measures to protect your data and applications." }
      ]
    },
    {
      ...
      details: [
        { title: "Business Process Automation", description: "Automate repetitive tasks and streamline your business operations." },
        { title: "System Integration", description: "Connect your existing systems and create a unified workflow." }
      ]
    },
    {
      id: "consulting",
      ...
      details: [
        { title: "Digital Transformation", description: "Guide your business through digital transformation with expert consulting." },
        { title: "Technology Strategy", description: "Develop a comprehensive technology strategy aligned with business goals." }
      ]
    }
  ], []);
...
${form.message || 'No additional details'}
    ...
    const waUrl = `https://wa.me/917719927774?text=${encoded}`;
    ...
    <div className="space-y-0" ref={sectionRef}>
      ...
      <section className="relative h-[80vh] flex items-center justify-center overflow-hidden text-white">
        <div className="absolute inset-0 w-full h-full">
          <video autoPlay muted loop playsInline className="w-full h-full object-cover" poster="/services.jpg">
        ...
        <div className="absolute inset-0">
          <motion.div className="absolute top-1/4 left-1/4 w-72 h-72 bg-purple-500/20 rounded-full blur-3xl"
            animate={{ scale: [1, 1.2, 1], opacity: [0.3, 0.6, 0.3] }}
            transition={{ duration: 8, repeat: Infinity, ease: "easeInOut" }}
          />
          <motion.div className="absolute bottom-1/3 right-1/4 w-96 h-96 bg-blue-500/20 rounded-full blur-3xl"
        ...
        <div className="relative z-10 text-center max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.3 }} variants={staggerContainer} className="space-y-8">
            ...
            <motion.div>
              <p className="text-xl sm:text-2xl md:text-3xl lg:text-4xl text-white leading-relaxed max-w-5xl mx-auto font-medium drop-shadow-lg">
                We deliver <span className="font-bold">cutting-edge digital solutions</span> that drive growth, efficiency, and innovation.
              </p>
            </motion.div>
      ...
      {/* STATS SECTION */}
      <motion.section className="py-16 bg-gradient-to-br from-gray-50 to-white" initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div className="grid grid-cols-2 lg:grid-cols-4 gap-8" variants={staggerContainer}>
            {companyStats.map((stat, index) => (
              <motion.div key={stat.label} variants={fadeUp} custom={index} className="text-center group" whileHover={{ y: -10 }}>
                <motion.div className={`bg-gradient-to-r ${stat.color} w-20 h-20 rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg group-hover:shadow-xl transition-all duration-300`} whileHover={{ scale: 1.1, rotate: 5 }}>
                  <stat.icon className="h-10 w-10 text-white" />
                </motion.div>
                <motion.h3 className="text-3xl font-bold text-gray-900 mb-2" initial={{ scale: 0 }} whileInView={{ scale: 1 }} transition={{ delay: index * 0.1 + 0.5, type: "spring" }}>
                  {stat.value}
                </motion.h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          <motion.div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8" variants={staggerContainer}>
            {services.map((service, index) => (
              <motion.div key={service.id} variants={fadeUp} custom={index} onHoverStart={() => setHoveredCard(service.id)} onHoverEnd={() => setHoveredCard(null)} className="relative group">
                <motion.div className={`absolute inset-0 bg-gradient-to-br ${service.gradient} rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-500`} animate={{ scale: hoveredCard === service.id ? 1.02 : 1 }} />
                <Card className="border-0 bg-white/5 backdrop-blur-md rounded-3xl shadow-2xl overflow-hidden border-white/10 group-hover:border-white/20 transition-all duration-500">
                  <CardContent className="p-8 space-y-6 relative z-10">
                    <motion.div className={`bg-gradient-to-r ${service.gradient} w-16 h-16 rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300`} whileHover={{ rotate: 360 }} transition={{ duration: 0.6 }}>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {service.features.map((feature, i) => (
                        <motion.span key={i} initial={{ opacity: 0, scale: 0 }} whileInView={{ opacity: 1, scale: 1 }} transition={{ delay: index * 0.1 + i * 0.1 }} className="px-3 py-1 bg-white/10 rounded-full text-xs text-white border border-white/20">
                          {feature}
                        </motion.span>
                      ))}
                    </div>
                    <motion.div whileHover={{ x: 5 }} transition={{ type: "spring", stiffness: 300 }}>
                      <Button onClick={() => toggleServiceDetails(service.id)} variant="outline" className="w-full bg-white/10 text-white border-white/20 hover:bg-white/20 hover:border-white/40">
                        {expandedService === service.id ? 'Hide Details' : 'Explore Service'}
                      </Button>
                    </motion.div>
                    <AnimatePresence>
                      {expandedService === service.id && (
                        <motion.div initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height: 'auto' }} exit={{ opacity: 0, height: 0 }} transition={{ duration: 0.3 }} className="space-y-4 border-t border-white/10 pt-4">
                          {service.details.map((detail, idx) => (
                            <motion.div key={idx} initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: idx * 0.1 }} className="space-y-2">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <motion.div className="grid md:grid-cols-2 gap-8" variants={staggerContainer}>
            {products.map((product, index) => (
              <motion.div key={product.id} variants={index % 2 === 0 ? slideInLeft : slideInRight} custom={index} whileHover={{ y: -10 }} transition={{ type: "spring", stiffness: 300 }} className="group">
                <Card className="border-0 shadow-2xl hover:shadow-3xl transition-all duration-500 overflow-hidden bg-gradient-to-br from-white to-gray-50 rounded-3xl">
                  <CardContent className="p-0">
                    <div className={`bg-gradient-to-r ${product.gradient} h-48 flex items-center justify-center relative overflow-hidden`}>
                      <motion.div className="absolute inset-0 bg-black/20" whileHover={{ opacity: 0 }} transition={{ duration: 0.3 }} />
                      <img src={product.image} alt={product.name} className="h-[400px] w-auto object-contain relative z-10 group-hover:scale-110 transition-transform duration-500" />
                    </div>
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="flex flex-wrap gap-2">
                          {product.features.map((feature, i) => (
                            <motion.span key={i} initial={{ opacity: 0, scale: 0 }} whileInView={{ opacity: 1, scale: 1 }} transition={{ delay: i * 0.1 }} className="px-3 py-1 bg-gray-100 text-gray-700 rounded-full text-sm font-medium border">
                              {feature}
                            </motion.span>
                          ))}
                        </div>
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="flex flex-wrap gap-2">
                          {product.tech.map((tech, i) => (
                            <motion.span key={i} initial={{ opacity: 0, scale: 0 }} whileInView={{ opacity: 1, scale: 1 }} transition={{ delay: i * 0.1 + 0.3 }} className="px-3 py-1 bg-blue-100 text-blue-700 rounded-full text-sm font-medium">
                              {tech}
                            </motion.span>
                          ))}
                        </div>
                      </div>
                      <motion.a href={product.link} target="_blank" rel="noopener noreferrer" whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} className="block w-full">
      ...
      <motion.section className="py-20 bg-gradient-to-b from-[#4B0082] to-[#6A0DAD] relative overflow-hidden" initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer}>
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div className="text-center space-y-6 mb-12" variants={staggerContainer}>
            <motion.div variants={scaleIn}>
              <Badge className="bg-green-500/20 text-green-300 px-6 py-2 text-sm border border-green-500/30">
            ...
            <motion.p variants={scaleIn} className="text-xl text-gray-300 max-w-2xl mx-auto">
              Fill in your details and we’ll connect with you instantly on WhatsApp.
            </motion.p>
          </motion.div>
                ...
                <form ref={formRef} onSubmit={handleSubmit} className="space-y-6">
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      ...
                      <Input id="name" name="name" value={form.name} onChange={handleFormChange} placeholder="Enter your full name" className="bg-white/10 border-white/20 text-white placeholder-gray-400" />
                      {errors.name && <p className="text-red-400 text-sm">{errors.name}</p>}
                    </div>
                    <div className="space-y-2">
                      <Label htmlFor="email" className="text-white">Email Address *</Label>
                      <Input id="email" name="email" type="email" value={form.email} onChange={handleFormChange} placeholder="Enter your email" className="bg-white/10 border-white/20 text-white placeholder-gray-400" />
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      ...
                      <Input id="phone" name="phone" value={form.phone} onChange={handleFormChange} placeholder="+91 7719927774" className="bg-white/10 border-white/20 text-white placeholder-gray-400" />
                      {errors.phone && <p className="text-red-400 text-sm">{errors.phone}</p>}
                    </div>
                    <div className="space-y-2">
                      <Label htmlFor="company" className="text-white">Company</Label>
                      <Input id="company" name="company" value={form.company} onChange={handleFormChange} placeholder="Your company name" className="bg-white/10 border-white/20 text-white placeholder-gray-400" />
                    </div>
                  </div>
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      ...
                      <Select value={form.service} onValueChange={(v) => handleSelect('service', v)}>
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea id="message" name="message" value={form.message} onChange={handleFormChange} placeholder="Tell us about your project, goals, timeline..." rows={5} className="bg-white/10 border-white/20 text-white placeholder-gray-400 resize-none" />
                  </div>

                  <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                    <Button type="submit" disabled={submitting} className="w-full bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 text-white py-3 rounded-xl font-semibold text-lg shadow-lg">
                      {submitting ? (
                        <>
